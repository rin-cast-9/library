    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="collapse navbar-collapse">
        ...
        <div v-if="currentUser">
          <router-link class="item navbar-brand" to="/listSubscriptions">Подписки</router-link>
          ...
          <router-link v-else class="item navbar-brand"
            :to="{ name: 'UserWallet', params: { id: currentUser.wallet_id } }">Кошелёк</router-link>
